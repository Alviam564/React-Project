...
const CardDetail = ({ card: cardArray, navProps, footProps, SearchbarSolo, onSearchChange, Barcolor, cardsData, searchTerm  }) => {
  ...
  const card = Array.isArray(cardArray) ? cardArray[0] : cardArray;
      ...
      <div id={idName} className={divClass}>
        <div className="card-details">
          ...
          <div id="card-containerS">
            ...
            <div className="sfix">
              <h1><strong>Name Or Names:</strong> {card.name}</h1>
